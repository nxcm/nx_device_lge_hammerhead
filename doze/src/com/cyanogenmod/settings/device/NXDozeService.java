...
public class NXDozeService extends Service {
    private static final String TAG = "NXDozeService";
    ...
    class NXProximitySensor implements SensorEventListener {
        ...
        public NXProximitySensor(Context context) {
    ...
    public void onCreate() {
        if (DEBUG) Log.d(TAG, "NXDozeService Started");
        mContext = this;
        mPowerManager = (PowerManager)getSystemService(Context.POWER_SERVICE);
        mSensor = new NXProximitySensor(mContext);
